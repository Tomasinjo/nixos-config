...
in {
  ...
  apps = {
    ...
    hermes.app = {
      glm = secrets.apps.hermes.app.glm;
      telegram_bot_token = secrets.apps.hermes.app.telegram_bot_token;
      telegram_allowed_users = secrets.apps.hermes.app.telegram_allowed_users;
    };
  };
}
